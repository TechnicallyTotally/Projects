...
function Kavo.CreateLib(kavName, themeList, hidebutton)
    ...
    spawn(function()
        do
            if hidebutton then
                ...
                hideButton.Position = UDim2.new(0.900, 0, 0.137, 0)
                hideButton.Size = UDim2.new(0, 21, 0, 21)
                hideButton.ZIndex = 2
                hideButton.Image = "rbxassetid://3926305904"
                hideButton.ImageRectOffset = Vector2.new(284, 4)
                hideButton.ImageRectSize = Vector2.new(24, 24)
    ...
    unhideButton.Visible = true
                ...
                unhideButton = Instance.new("ImageButton")
                unhideButton.Name = "unhideButton"
                unhideButton.Parent = MainHeader
                unhideButton.BackgroundTransparency = 1
                unhideButton.Position = UDim2.new(0.028, 0, 0.028, 0)
                unhideButton.Size = UDim2.new(0, 30, 0, 30)
                unhideButton.ZIndex = 2
                unhideButton.Visible = false
                unhideButton.Image = "rbxassetid://3926305904"
                unhideButton.ImageRectOffset = Vector2.new(4, 4)
                unhideButton.ImageRectSize = Vector2.new(16, 16)
                ...
                sliderBtn.MouseButton1Down:Connect(function()
                    if not focusing then
                        ...
                        releaseconnection = uis.InputEnded:Connect(function(Mouse)
                            if Mouse.UserInputType == Enum.UserInputType.MouseButton1 or Mouse.UserInputType.Name == 'Touch' then
                                Value = math.floor((((tonumber(maxvalue) - tonumber(minvalue)) / 149) * sliderDrag.AbsoluteSize.X) + tonumber(minvalue))
                                pcall(function()
                                    callback(Value)
                                end)
