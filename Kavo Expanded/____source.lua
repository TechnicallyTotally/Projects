...
function Kavo.CreateLib(kavName, themeList, hidetoggle)
   ...
   if hidetoggle then
      ...
      unhideButton.Parent = Main
      unhideButton.BackgroundTransparency = 1
      unhideButton.Position = UDim2.new(0, 10, 0.5, -25)
      ...
      local function hideGui()
         ...
         TweenService:Create(unhideButton, TweenInfo.new(0.3), { BackgroundTransparency = 0 }):Play()
      end
            ...
            if element:IsA("GuiObject") then
               if not element.Visible then
                  TweenService:Create(element, TweenInfo.new(0.3), {
                     ...
                     Position = element.Name == "UnhideButton" and UDim2.new(0.5, -50, 0.5, -25) or UDim2.new(0, 0, 0, 0),
                     Size = element.Name == "UnhideButton" and UDim2.new(0, 100, 0, 50) or UDim2.new(0, 0, 0, 0),
                  }):Play()
               end
            end
         end
         TweenService:Create(unhideButton, TweenInfo.new(0.3), { BackgroundTransparency = 1 }):Play()
      end

      hideButton.MouseButton1Click:Connect(hideGui)
      unhideButton.MouseButton1Click:Connect(unhideGui)

      unhideButton.MouseButton1Click:Connect(
      function()
         if hidden then
            unhideGui()
         end
