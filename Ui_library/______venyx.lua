...
do
    ...
    local isMobileDevice = uis.TouchEnabled

    if isMobileDevice then
        slider.TouchStarted:Connect(function(input)
            dragging = true
        ...
        slider.TouchEnded:Connect(function()
            dragging = false
            if inputConnection then
                inputConnection:Disconnect()
                inputConnection = nil
        ...
        slider.TouchMoved:Connect(function(input)
            if dragging then
                utility:Tween(circle, {ImageTransparency = 0}, 0.1)
        ...
        -- Desktop code (mouse input) remains the same
